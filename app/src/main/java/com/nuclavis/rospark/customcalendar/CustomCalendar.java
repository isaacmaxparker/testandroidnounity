...
import com.nuclavis.rospark.R;

import com.nuclavis.rospark.customcalendar.OnDateSelectedListener;
import com.nuclavis.rospark.customcalendar.OnNavigationButtonClickedListener;
...
public class CustomCalendar extends LinearLayout {
    ...
    private void readyDaysOfWeek() {
        String[] arrOfDaysOfWeek = {
                getResources().getString(R.string.mobile_training_guide_calendar_sunday),
                getResources().getString(R.string.mobile_training_guide_calendar_monday),
                getResources().getString(R.string.mobile_training_guide_calendar_tuesday),
                getResources().getString(R.string.mobile_training_guide_calendar_wednesday),
                getResources().getString(R.string.mobile_training_guide_calendar_thursday),
                getResources().getString(R.string.mobile_training_guide_calendar_friday),
                getResources().getString(R.string.mobile_training_guide_calendar_saturday),
        };
        int j = 0;
